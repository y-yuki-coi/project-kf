...
m1 * dt2_x1  ==   Fx2 + Fx3 - Fa2*cos(th2) - Fa3*cos(th3), .... % HAT (x)
m1 * dt2_y1  ==   Fy2 + Fy3 -m1 * g + Fa2*sin(th2) + Fa3*sin(th3), .... % same as above (y)
m2 * dt2_x2  == - Fx2 + Fgx2 + Fa2*cos(th2), .... % Leg_R
m2 * dt2_y2  == - Fy2 + Fgy2 -m2 * g - Fa2*sin(th2), ....
I2 * dt2_th2 == - Fx2*(l2/2)*sin(th2) - Fy2*(l2/2)*cos(th2) ... % Leg_R 
                - Fgx2*(l2/2)*sin(th2) - Fgy2*(l2/2)*cos(th2) ... % from force
...
I2 * dt2_th3 == - Fx3*(l2/2)*sin(th3) - Fy3*(l2/2)*cos(th3) ... % Leg_L
